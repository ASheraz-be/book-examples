...
# can_delete: If you set this to True, Django will include a Boolean field for each form that will be rendered 
# as a checkbox input. It allows you to mark the objects that you want to delete.
